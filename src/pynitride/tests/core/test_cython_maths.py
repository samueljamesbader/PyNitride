...
import numpy as np
from pynitride.core.cython_maths import fd12,fd12p, tdma
...
def test_fd12():
    r"""Spot-checks :py:func:`~pynitride.core.cython_maths.fd12` against a couple Nanohub-computed values."""
...
def test_fd12p():
    r"""Spot-checks :py:func:`~pynitride.core.cython_maths.fd12p` against a couple Nanohub-computed values."""
...
def test_fd_timing(capfd):
    r"""Tests how fast the :py:func:`~pynitride.core.cython_maths.fd12` and :py:func:`~pynitride.core.cython_maths.fd12`
...
def test_tdma():
    r""" Tests :py:func:`~pynitride.core.cython_maths.tdma` numerically for a random tridiagonal problem."""
...
def test_tdma_timing():
    r""" Tests how fast :py:func:`~pynitride.core.cython_maths.tdma` computes a large problem."""
    numvalues=10000
    Nrepeat=100
    ...
    assert tdma_timing <6e-4, "TDMA running slow"
