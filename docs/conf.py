...
# -*- coding: utf-8 -*-
#
# PyNitride documentation build configuration file, created by
...
from pynitride import __version__
...
version = __version__.split("rc")[0]
...
htmlhelp_basename = 'PyNitridedoc'
...
latex_documents = [
    (master_doc, 'PyNitride.tex', 'PyNitride Documentation',
     'Samuel James Bader', 'manual'),
]
...
man_pages = [
    (master_doc, 'pynitride', 'PyNitride Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyNitride', 'PyNitride Documentation',
     author, 'PyNtride', 'Everything the III-Nitride engineer needs at his/her fingertips.',
     'Miscellaneous'),
]
