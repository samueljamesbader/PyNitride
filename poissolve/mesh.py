...
class Layer():
    ...
    def get_property(self,key,**kwargs):
        try: return multilevel_get(self.material,key,**kwargs)
        except: raise Exception("Couldn't find property "+str(key)+" in Material "+self._matname)
...
if __name__=='__main__':
    import pytest
    from poissolve.testing import test_mesh as tester
